...
function execute(url, page) {
    if (!page) page = 0
    let newurl = `https://fanqienovel.com/api/author/library/book_list/v0/?page_count=18&page_index=${page}&gender=1&${url}&creation_status=-1&word_count=-1&book_type=-1&sort=0`
    console.log(newurl)
